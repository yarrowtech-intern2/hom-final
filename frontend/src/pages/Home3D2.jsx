...
const HOME_DAWN_GRADIENT =
  "radial-gradient(110% 58% at 50% 100%, rgba(212, 222, 228, 0.35) 0%, rgba(212, 222, 228, 0) 52%), radial-gradient(88% 60% at 50% 18%, rgba(244, 249, 255, 0.92) 0%, rgba(244, 249, 255, 0) 66%), linear-gradient(180deg, #e8f3ff 0%, #bed9f3 38%, #8db9e3 70%, #5f95cb 100%)";
...
function Scene({ isMobile, lowSpec }) {
  ...
  return (
    <>
      ...
      {/* Softer lights on mobile */}
      <hemisphereLight intensity={isMobile ? 0.02 : 0.026} color="#dcecff" groundColor="#2d2f33" />
      <directionalLight
        castShadow={!isMobile}
        position={[10, 15, 10]}
        intensity={isMobile ? 0.05 : 0.065}
        shadow-mapSize-width={1024}
        shadow-mapSize-height={1024}
        color="#eef5ff"
      />
